...
const Footer = () => {
    return (
        <div>
            <footer className="text-center lg:text-left bg-blue-200 text-gray-600">
          ...
          ">
                        ...
                        <div className="">
                            ...
                            <p className="mb-4">
                                <a href="#!" className="text-gray-600">Create Item</a>
                            </p>
                            <p className="mb-4">
                                <a href="#!" className="text-gray-600">My Collections</a>
                            </p>
                            <p>
                                <a href="#!" className="text-gray-600">My Creations</a>
                            </p>
                        </div>
                ...
                <div className="text-center p-6 bg-blue-300">
                    ...
                    <a className="text-gray-600 ">Developed by Tathagat Saha a.k.a Tatz</a>
                </div>
            </footer>
        </div>
    )
